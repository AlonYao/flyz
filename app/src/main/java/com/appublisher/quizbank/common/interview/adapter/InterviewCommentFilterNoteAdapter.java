 ...
 */
public class InterviewCommentFilterNoteAdapter extends BaseAdapter {
    private Context context;
    private List<CommentFilterResp.NotesBean> list;


    public InterviewCommentFilterNoteAdapter(Context context, List<CommentFilterResp.NotesBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textView.setText(list.get(position).getNote_name());
        return convertView;
    }
