 ...
 */
public class InterviewCommentFilterStatusAdapter extends BaseAdapter {
    private Context context;
    private List<CommentFilterResp.StatusBean> list;


    public InterviewCommentFilterStatusAdapter(Context context, List<CommentFilterResp.StatusBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textView.setText(list.get(position).getComment_status());
        return convertView;
    }
