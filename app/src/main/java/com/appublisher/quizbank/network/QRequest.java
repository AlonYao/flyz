...
public class QRequest extends Request implements QApiConstants {
    ...
    public void getMockExerciseList() {
        asyncRequest(getFinalUrl(getMockExerciseList), "mock_exercise_list", "object");
    }
    ...
    public void getOpenCourseUrl(int course_id) {
        asyncRequest(getFinalUrl(getOpenCourseUrl) + "&is_open=true&course_id=" + course_id,
    ...
    public void getOpenCourseConsult(int course_id) {
        asyncRequest(getFinalUrl(getOpenCourseConsult) + "&course_id=" + course_id,
    ...
    public void getFreeOpenCourseStatus() {
        asyncRequest(getFinalUrl(getFreeOpenCourseStatus),
    ...
    public void getPromoteLiveCourse() {
        asyncRequest(getFinalUrl(getPromoteLiveCourse), "promote_live_course", "object");
    }
