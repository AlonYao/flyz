...
public class ParseManager {
	...
	public class ParsedSegment {
		...
		public final MatchInfo.MatchType type;	// 分段类型。
		public ParsedSegment(CharSequence text, MatchInfo.MatchType type) {
			this.text = text;
			this.type = type;
		}
...
//        		}
                builder.append(toParse.subSequence(cursor, info.getStart()));
        		mSegments.add(new ParsedSegment(builder, MatchInfo.MatchType.None));
