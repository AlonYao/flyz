...
public abstract class IParser {
	 ...
	 */
	protected final void checkAreaLegitimacy(CharSequence toParse, MatchInfo.MatchType areaT, int areaS, int areaE) {
		// 当前匹配到的富文本始终点不合法。
		if (areaS > areaE) {
		...
		MatchInfo.MatchType polluteType = MatchInfo.MatchType.None;
